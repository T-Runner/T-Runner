...
export const exercisesdata = [
  createDataExercise(
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQe8BtgN04salqSqXG_hA4lb-WDwetpZprN0jtb_ucY95CpIUXWyTTvVMCEBMEhRgKvg6k&usqp=CAU",
...
export const groupData = [
  ...
  createDataGroups(
    "Group B",
    "Enjoy the moment that you...",
    "Sioux Falls, Wisconsin",
    "CrossFit",
    "Other ",
    "01/07/2023",
    178,
