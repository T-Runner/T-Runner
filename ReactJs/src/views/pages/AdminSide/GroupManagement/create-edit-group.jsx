  ...
  return (
    <div>
      ...
      <div className="mt-5 flex justify-between">
        <p className="font-barlow font-bold uppercase text-28">
          Create a new Group
        </p>
        <div>
          <button
      ...
      <div className="mt-8 grid grid-cols-5">
            ...
            <div className="tooltip cursor-pointer">
              ...
              <span className="tooltiptext-help-icon font-barlow px-6 pt-4 pb-6">
                <div className="flex ">
                  ...
                  <p className="font-semibold text-14 ml-2">
                    Invite-Only Group
                  </p>
                </div>
                <div className="mt-4 ">
                  <p>
                    Runners must request permission to join an invite-only
                    Group.
                  </p>
                  <p className="mt-4">
                    Only admins can approve new Group members. Recent activity,
                    club announcements, discussions and private group events
                    will be hidden from non-members.
                  </p>
                </div>
              </span>
            </div>
        ...
        <UploadImage type="Group Picture" />
      </div>
      {showModal && (
        <ModalConfirm
          isShow={showModal}
