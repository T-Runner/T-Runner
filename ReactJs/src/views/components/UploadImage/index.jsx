    ...
    return (
      <div>
        ...
        <div className="flex justify-center">
          <div>
            <label htmlFor="dropzone-file">
              <div className="flex items-center cursor-pointer">
                <CameraIcon />
                <p className="ml-1 uppercase font-barlow font-semibold text-ct4-dark-green">
                  Change
                </p>
              </div>
              <input
          ...
          >
            <RecycleBinIcon />
            <button className="ml-1 uppercase font-barlow font-semibold text-ct4-dark-green">
              Remove
            </button>
          </div>
        </div>
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center pt-5 pb-6">
          <UploadImageIcon />
          <p className="mt-6 font-barlow text-ct4-gray-3">
            Maximum size is 2MB
          </p>
          <div className="flex gap-x-1 mt-4">
            <p className="font-barlow underline text-ct4-dark-green">
              Click to upload
            </p>
